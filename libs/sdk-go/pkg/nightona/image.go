...
//	image := nightona.Base("python:3.11-slim").
...
// Example:
//
//	image := nightona.Base("ubuntu:22.04")
//	image := nightona.Base("python:3.11-slim")
//	image := nightona.Base("node:18-alpine")
...
//	version := "3.10"
//	image := nightona.DebianSlim(&version)
...
//	WORKDIR /app`
//	image := nightona.FromDockerfile(dockerfile)
...
//
//	// Basic installation
//	image := nightona.Base("python:3.11").PipInstall([]string{"numpy", "pandas"})
//
//	// With options
//	image := nightona.Base("python:3.11").PipInstall(
//	    []string{"torch"},
...
// Example:
//
//	image := nightona.Base("ubuntu:22.04").AptGet([]string{"git", "curl", "build-essential"})
...
// Example:
//
//	image := nightona.Base("python:3.11").
//	    Env("PYTHONUNBUFFERED", "1").
...
// Example:
//
//	image := nightona.Base("python:3.11").PipInstall([]string{"numpy"})
