...
//	@title			Nightona Toolbox API
//	@version		v0.0.0-dev
//	@description	Nightona Toolbox API. The base URL comes from the sandbox's `toolboxProxyUrl` field (returned in sandbox DTO by the main Nightona API) plus the sandbox ID: `{toolboxProxyUrl}/{sandboxId}/{endpoint}`. Default for Nightona Cloud: `https://proxy.app.daytona.io/toolbox/{sandboxId}`.
//	@schemes		https
...
import (
	...
	session_svc "github.com/nightona-co/nightona/apps/daemon/pkg/session"
	...
	"github.com/nightona-co/nightona/apps/daemon/pkg/toolbox/git"
	"github.com/nightona-co/nightona/apps/daemon/pkg/toolbox/lsp"
	"github.com/nightona-co/nightona/apps/daemon/pkg/toolbox/port"
	"github.com/nightona-co/nightona/apps/daemon/pkg/toolbox/process"
	"github.com/nightona-co/nightona/apps/daemon/pkg/toolbox/process/coderun"
	"github.com/nightona-co/nightona/apps/daemon/pkg/toolbox/process/interpreter"
	"github.com/nightona-co/nightona/apps/daemon/pkg/toolbox/process/pty"
	"github.com/nightona-co/nightona/apps/daemon/pkg/toolbox/process/session"
	"github.com/nightona-co/nightona/apps/daemon/pkg/toolbox/proxy"
	...
	"github.com/nightona-co/nightona/apps/daemon/pkg/toolbox/docs"
...
func (s *server) Start() error {
	...
	docs.SwaggerInfo.Description = "Nightona Toolbox API"
	docs.SwaggerInfo.Title = "Nightona Toolbox API"
	...
	go func() {
		...
		pluginPath := "/usr/local/lib/nightona-computer-use"
		// Fallback to local config directory for development
		if _, err := os.Stat(pluginPath); os.IsNotExist(err) {
			pluginPath = path.Join(s.configDir, "nightona-computer-use")
		}
