...
sandbox = nightona.create(
    CreateSandboxFromSnapshotParams(
        volumes=[VolumeMount(volume_id=volume.id, mount_path="/home/nightona/data")]
    )
)
```
...
const sandbox = await nightona.create({
    volumes: [{ volumeId: volume.id, mountPath: '/home/nightona/data' }]
});
```
...
public class App {
    public static void main(String[] args) {
        try (Nightona nightona = new Nightona()) {
            ...
            mount.setMountPath("/home/nightona/data");
...
nightona create --volume my-volume:/home/nightona/data
```
...
sandbox.git.clone("https://github.com/Amartuvshins0404/nightona.git", "/home/nightona/nightona")
status = sandbox.git.status("/home/nightona/nightona")
...
await sandbox.git.clone('https://github.com/Amartuvshins0404/nightona.git', '/home/nightona/nightona');
const status = await sandbox.git.status('/home/nightona/nightona');
...
func main() {
    ...
    sandbox.Git.Clone(context.Background(), "https://github.com/Amartuvshins0404/nightona.git", "/home/nightona/nightona")
    status, err := sandbox.Git.Status(context.Background(), "/home/nightona/nightona")
    if err != nil {
        log.Fatal(err)
    }
...
sandbox.git.clone(url: "https://github.com/Amartuvshins0404/nightona.git", path: "/home/nightona/nightona")
status = sandbox.git.status("/home/nightona/nightona")
...
public class App {
    public static void main(String[] args) {
        try (Nightona nightona = new Nightona()) {
            Sandbox sandbox = nightona.create();
            sandbox.git.clone("https://github.com/Amartuvshins0404/nightona.git", "/home/nightona/nightona");
            GitStatus status = sandbox.git.status("/home/nightona/nightona");
...
curl 'https://proxy.app.daytona.io/toolbox/{sandboxId}/git/clone' \
  ...
  "path": "/home/nightona/nightona"
}'

# Get repository status
curl 'https://proxy.app.daytona.io/toolbox/{sandboxId}/git/status?path=/home/nightona/nightona' \
  --header 'Authorization: Bearer <API_KEY>'
```
